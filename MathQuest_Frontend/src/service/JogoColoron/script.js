...
class Game {
    ...
    //     // window.open("://https://twitter.com/intent/tweet?url=httpscodepen.io/gregh/full/yVLOyO&amp;text=I scored " +
    //     //     this.score +
    //     //     " points on Coloron! Can you beat my score?&amp;via=greghvns&amp;hashtags=coloron", "TweetWindow", "width=600px,height=300px,top=" + top + ",left=" + left);
    // }
    /**
    ...
    intro() {
        ...
        $(".stop-game-quiz").css("display", "none");
        ...
        ball
            .fromTo(".start-game .section-1 .ball-demo", 0.5, { y: "0px" }, {
            y: "100px",
            scaleY: 1.1,
...
fimDoJogo() {
  ...
  setTimeout(function() {
    ...
    start() {
        ...
        // }
        // redefinir a escala de tempo para normal conforme o jogo acelera
    ...
    pause() {
        this.isRunning = 0;
        $(".start-game, .stop-game ,.stop-game-quiz").css("display", "none");
        // Pausa o jogo
...
class Animation {
    ...
    playTriangle(el) {
        ...
        triangle
            .staggerFromTo(el.find(".triangle"), 0.3, { scale: 0.1 }, { scale: 1 }, 0.03)
